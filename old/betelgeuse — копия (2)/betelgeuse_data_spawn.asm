...
Level1SpawnsTimerHiLow:
	DB <(Level1Room1SpawnTimerHi), <(Level1Room2SpawnTimerHi)
...
Level1SpawnsTimerLowLow:
	DB <(Level1Room1SpawnTimerLow), <(Level1Room2SpawnTimerLow)
...
;-------------------
Level1SpawnsNumsLow:
	DB <(Level1Room1SpawnNums), <(Level1Room2SpawnNums)
Level1SpawnsNumsHi:
	DB >(Level1Room1SpawnNums), >(Level1Room2SpawnNums)
...
;-------------------
Level1SpawnsXLow:
	DB <(Level1Room1SpawnX), <(Level1Room2SpawnX)
Level1SpawnsXHi:
	DB >(Level1Room1SpawnX), >(Level1Room2SpawnX)
...
;-------------------
Level1SpawnsYLow:
	DB <(Level1Room1SpawnY), <(Level1Room2SpawnY)
Level1SpawnsYHi:
	DB >(Level1Room1SpawnY), >(Level1Room2SpawnY)
...
Level1SpawnsXNameTableLow:
	DB <(Level1Room1SpawnXNameTable), <(Level1Room2SpawnXNameTable)
...
Level1SpawnsYNameTableLow:
	DB <(Level1Room1SpawnYNameTable), <(Level1Room2SpawnYNameTable)
...
Level1SpawnsTypeLowLow:
	DB <(Level1Room1SpawnsTypeLow), <(Level1Room1SpawnsTypeLow)
Level1SpawnsTypeLowHi:
	DB >(Level1Room1SpawnsTypeLow), >(Level1Room1SpawnsTypeLow)
Level1SpawnsTypeHiLow:
	DB <(Level1Room1SpawnsTypeHi), <(Level1Room1SpawnsTypeHi)
...
Level1Room1SpawnsMaxEnemiesLow:
	DB <(Level1Room1SpawnsMaxEnemies), <(Level1Room2SpawnsMaxEnemies)
